...
AGE_PROMPTS = {
    "Молодая": "young adult woman, approximately 20s, same stable body shape and body mass, youthful skin quality, smooth even skin texture, firm skin surface, fine pores, high skin elasticity, minimal fine lines, minimal creasing at joints, fresh uniform skin texture on face, neck, arms, abdomen and legs, (youthful natural breast shape:1.2), firm natural breast support, higher natural breast position, compact supported breast contour",
    "Милф": "adult woman approximately late 30s to mid 40s, same stable body shape and body mass, naturally mature skin quality, realistic fine skin texture, subtle fine lines, mild expression lines, slightly reduced skin elasticity, subtle natural creasing at joints, slightly softer skin texture on face, neck, arms, abdomen and legs, no major silhouette change, (moderately reduced breast firmness:1.2), mild age-related breast tissue relaxation, slightly lower natural breast position, softer relaxed breast contour while preserving the same bust size",
    "Зрелая": "adult woman approximately 55 to 65 years old, same stable body shape and body mass, clearly mature skin quality, realistic pronounced skin texture, visible fine and medium wrinkles, deeper natural skin creases, reduced skin elasticity, more noticeable natural folding and fine lines around joints, visibly textured skin on face, neck, arms, abdomen and legs, age-related skin changes without changing body weight or silhouette, (noticeably reduced breast firmness:1.3), clear age-related breast tissue relaxation, lower natural breast position, softer downward-relaxed breast contour, reduced upper breast fullness while preserving the same bust size",
}

AGE_NEGATIVE_PROMPTS = {
    "Молодая": "deep wrinkles, pronounced crow's feet, deep nasolabial folds, heavy skin texture, pronounced skin laxity, loose skin, strongly aged skin, severe creasing, elderly skin, aged breast tissue, pronounced breast sagging, lowered breast position, downward-relaxed breast contour, reduced breast firmness",
    "Милф": "elderly skin, deep severe wrinkles, heavy sagging skin, extreme age spots, severe skin laxity, very loose skin, strongly aged skin texture, extreme breast sagging, strongly aged breast tissue, strongly lowered breast position, extreme downward breast contour",
    "Зрелая": "perfectly smooth youthful skin, completely unlined skin, baby-smooth skin, minimal skin texture, high youthful skin elasticity, no fine lines, no natural creasing, youthful firm skin support, youthful breast contour, high breast position, compact supported breast shape",
}
